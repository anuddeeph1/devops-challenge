# Terraform Variable Values - NO ALB Configuration (Cost Optimized)
# This removes the ALB and uses public nodes with NodePort
# Monthly Cost: ~$140 (saves $24/month)
...
# Load Balancer Configuration - NOT USED
